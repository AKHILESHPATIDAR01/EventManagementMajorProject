      ...
      <BrowserRouter>
          ...
          <Switch>
            ...
            <Route path="/stepone" exact>
                <StepOne guests = {noOfGuests} updateGuests={setNoOfGuests} />
            </Route>
          </Switch>
          <Switch>
            <Route path="/steptwo" exact>
                <StepTwo  venue={venue} setVenue={setVenue}/>
            </Route>
          </Switch>
          <Switch>
            <Route path="/stepthree" exact>
                <StepThree cartitem={cartitems} setCartItems={setCartItems} />
            </Route>
          </Switch>
          <Switch>
          ...
          <Switch>
            <Route path="/cart" exact>
                <Cart cartitem={cartitems} setCartItems={setCartItems} venue={venue} setVenue={setVenue} />
            </Route>
          </Switch>
      </BrowserRouter>
    </div>
